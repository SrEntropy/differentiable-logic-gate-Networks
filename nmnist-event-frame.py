...
### PWZ NEW CODE
train = torch.load("datasets/nmnist_train_event_frames.pt")
...
test = torch.load("datasets/nmnist_test_event_frames.pt")
...
val = torch.load("datasets/nmnist_test_event_frames.pt")
val_images = val["data"]
