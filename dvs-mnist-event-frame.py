...
IMG_WIDTH = int(config.get("IMG_WIDTH", 128)) # 16 is suitable for Tiny Tapeout
IMG_CROP = int(config.get("IMG_CROP", 128))
...
### PWZ NEW CODE
train = torch.load("datasets/dvsmnist_train_event_frames.pt")
...
test = torch.load("datasets/dvsmnist_test_event_frames.pt")
...
# val = torch.load("datasets/dvsmnist_test_event_frames.pt")
# val_images = val["data"]
